...
if(ii < 10){
  frames.push("http://maps-beta.customweather.com/cw_tiles/zr_FX9XukUgZetYI9JIINzkhlcktJjS3yqEV3rKXuGFiNCDT1gtcCGKuFkc1jQzl/"+layerName+"/"+ ts + "/{quadkey}.png" + (isPast ? "" : "?" + futureLayerQueryString ));
}
