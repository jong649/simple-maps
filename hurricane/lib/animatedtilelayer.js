...
********************************************************************************/
function AnimatedTileLayer(map, frames, options) {
  ...
  */
  ...
  function _init() {
    ...
    _animatedTileLayer = new Microsoft.Maps.EntityCollection();
    map.entities.push(_animatedTileLayer);
  ...
  function _redraw() {
    ...
    if (_animatedTileLayer.getLength() == 1) {
      var x = _animatedTileLayer.get(0);
    ...
    // If there is more than one frame
      ...
      switch (_options.mode) {
        ...
        case 'safe':
          ...
          var x = _animatedTileLayer.get(1);
          x.setOptions({ opacity: _options.opacity });
          break;
...
Microsoft.Maps.moduleLoaded('newanimatedTileLayerModule');
