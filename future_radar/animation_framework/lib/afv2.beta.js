 ...
 * =========================================================================== 
         "hrrrsub3km" : {
            "model_update" : "2015-07-04T04:00:00",
            "last_modified" : "2015-07-01T07:00:00",
            "ts0_timestep_min" : 0,
            "fore_timestep_min" : 15,
            "num_timesteps" : 61,
            "init_timestep_min" : 60
         }
    //$('#isodate').html("<strong>"+ts+"</strong>");
> 
> var slider = document.getElementById("slider");
> console.log("in");
> console.log(meta.num_timesteps);
> slider.max=meta.num_timesteps;
> console.log(slider);
> console.log("out");
...
var cwsLatest = new Date(meta.model_update + "Z");
var now = cwsLatest;


var futureNumFrames = meta.num_timesteps/_incr;
var futureAnimTimestep = meta.fore_timestep_min*60*1000*_incr;
var futureInitialOffset = 0;
var futureInitialModulus = meta.fore_timestep_min*60*1000;
...
function updateAnimationExplicit(explicitCall){
   ...
   // console.log("updateAnimationExplicit("+explicitCall +"):" + new Date().getTime() + ": iter :" + this.iter + ":current frame:" + currentFrame);
    ...
    var vText = document.getElementById("cwtitle");
        vText.innerHTML = '<h1>'+meta.description + "</h1> <h2>" + __cwslayerspec.description+'</h2>';
