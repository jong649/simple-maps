...
function initialize() {
    ...
    warnings.loadGeoJson('/templates/IAAI/maptile/nws_alerts/nws_alerts_poly.json');
    ...
    watches.loadGeoJson('/templates/IAAI/maptile/nws_alerts/nws_alerts_poly.json',{}, function (d){
  ...
  for (i = 0; i < activeLocations.length; i++)
	...
	facArray.push(marker);
		...
		console.log(marker);
	    	...
	    	'<div><a href="http://clients.customweather.com/templates/IAAI/current.php?client_ID=iaai_portal&wid='+_id+'&metric=false&language=en" target="_blank">'+
